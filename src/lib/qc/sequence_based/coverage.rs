...
//     histograms: HashMap<String, MutexBackedHistogram>,
// }

// #[derive(Default)]
// pub struct CoverageHistograms<'a> {
//     storage: HashMap<&'a str, MutexBackedHistogram>,
// }
...
//             .or_insert_with(|| {
//                 MutexBackedHistogram::zero_based_with_capacity(usize::from(seq.len()))
//             });
...
//         let mut coverages = MutexBackedHistogram::zero_based_with_capacity(1024);
//         let mut ignored = 0;
